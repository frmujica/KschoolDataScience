...
#The next functions are going to be optional, the main goal is to download the Knowledge base, aKa KB, from Qualys API and save into file that we define in the variable "plugins_output_file", then the code is going to proccess this file for categorizing Qualys plugins.

#Read the API credentials from a cfg file and then it will be used in to download the KB.
